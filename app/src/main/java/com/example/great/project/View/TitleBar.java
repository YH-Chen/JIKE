package com.example.great.project.View;
...
public class TitleBar extends ViewGroup implements View.OnClickListener {
  ...
  protected void onLayout(boolean changed, int l, int t, int r, int b) {
    ...
    mRightLayout.layout(mScreenWidth - mRightLayout.getMeasuredWidth(), mStatusBarHeight, mScreenWidth,
        mRightLayout.getMeasuredHeight() + mStatusBarHeight);
    if (mLeftText.getMeasuredWidth() > mRightLayout.getMeasuredWidth()) {
      mCenterLayout.layout(mLeftText.getMeasuredWidth(), mStatusBarHeight, mScreenWidth - mLeftText.getMeasuredWidth(),
          getMeasuredHeight());
    } else {
